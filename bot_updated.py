...
async def main():
    ...
    if not BOT_TOKEN:
        print("❌ FATAL: BOT_TOKEN is missing/empty in this process's environment.")
        print("Check: heroku config:get BOT_TOKEN")
        raise SystemExit(1)
    print(f"✅ BOT_TOKEN loaded (length={len(BOT_TOKEN)}, starts with '{BOT_TOKEN[:6]}...')")
